...
//
//public class UserProfileFragment extends SherlockFragment implements ProfileDownloadListener, AvatarDownloadListener {
...
//			Thread thread = new ProfileDownloadThread(url, cookieStore, handler);
//			thread.start();
//		}
//		
//		return inflatedView;
...
//			}
//		} else {
//			super.getSherlockActivity().getSupportActionBar().setTitle(user.getName());
//			
...
//			profileTextView.setText(user.getSummary());
...
//		
//		ProfileDownloadThread(String url, CookieStore cookies, Handler handler) {
//			mUrl = url;
//			mCookies = cookies;
//			setHandler(handler);
//		}
